...
const ddep = [
    ...
    { x: 270, y: 5, z: 90 , id :84,ip:"10.101.81.180"}, 
    { x: 300, y: 5, z: 90 , id :85,ip:"10.101.81.33"}, 
    { x: 240, y: 5, z: 120 , id :86,ip:"10.101.81.53"}, 
    { x: 270, y: 5, z: 120 , id :87,ip:"10.101.81.220"},  
]
ddep.forEach(x=>{
    x.dep="ddep"
    nexus.links.push({
...
nexus.links.push(
    ...
    { target:123, source:121 }, //交换机-入侵检测
